...
*
* \funcusage
*  \snippet HSync_SUT.c usage_HSync_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet HSync_SUT.c usage_HSync_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet HSync_SUT.c usage_HSync_Read  
*******************************************************************************/
...
* preferred HSync_Read() API because the 
* HSync_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet HSync_SUT.c usage_HSync_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    *  component. Or you may use HSync_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - HSync_0_INTR       (First pin in the list)
    *  - HSync_1_INTR       (Second pin in the list)
    *  - ...
    *  - HSync_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet HSync_SUT.c usage_HSync_SetInterruptMode
    *******************************************************************************/
    void HSync_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & HSync_0_INTR) != 0u) 
		{ 
			 HSync_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet HSync_SUT.c usage_HSync_ClearInterrupt
    *******************************************************************************/
