...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=false, Compare1_8=true, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=152, CompareValue2=63, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG8, CySetRegReplacementString=CY_SET_REG8, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=200, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg8, RegSizeReplacementString=uint8, Resolution=8, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=true, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=false, UDB8=true, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP8, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONFIG_TITLE=ServoPWM, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ServoPWM, CY_INSTANCE_SHORT_NAME=ServoPWM, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=ServoPWM, )
module PWM_v3_30_7 (
    reset,
    clock,
    tc,
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("f58f3d89-b5b4-4678-9728-d17209b2ad59"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__VerifyCompIn_net;
	wire [0:0] tmpFB_0__VerifyCompIn_net;
	wire [0:0] tmpIO_0__VerifyCompIn_net;
	wire [0:0] tmpINTERRUPT_0__VerifyCompIn_net;
	electrical [0:0] tmpSIOVREF__VerifyCompIn_net;

	cy_psoc3_pins_v1_10
		#(.id("a4d416c5-eceb-49f1-aa0b-8a7d8186af92"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		VerifyCompIn
		 (.oe(tmpOE__VerifyCompIn_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__VerifyCompIn_net[0:0]}),
		  .analog({Net_2563}),
		  .io({tmpIO_0__VerifyCompIn_net[0:0]}),
		  .siovref(tmpSIOVREF__VerifyCompIn_net),
		  .interrupt({tmpINTERRUPT_0__VerifyCompIn_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	wire [0:0] tmpOE__VerifyCompOut_net;
	wire [0:0] tmpFB_0__VerifyCompOut_net;
	wire [0:0] tmpIO_0__VerifyCompOut_net;
	wire [0:0] tmpINTERRUPT_0__VerifyCompOut_net;
	electrical [0:0] tmpSIOVREF__VerifyCompOut_net;

	cy_psoc3_pins_v1_10
		#(.id("4ef53510-d43e-4224-824c-050863059cff"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		VerifyCompOut
		 (.oe(tmpOE__VerifyCompOut_net),
		  .y({Net_2541}),
		  .fb({tmpFB_0__VerifyCompOut_net[0:0]}),
		  .io({tmpIO_0__VerifyCompOut_net[0:0]}),
		  .siovref(tmpSIOVREF__VerifyCompOut_net),
		  .interrupt({tmpINTERRUPT_0__VerifyCompOut_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__VerifyCompOut_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    defparam VDAC.Initial_Value = 0;
    defparam VDAC.Strobe_Mode = 0;


    assign Net_2535 = ~Net_2635;

    PWM_v3_30_7 ServoPWM (
        .reset(1'b0),
        .clock(Net_2693),
        .tc(Net_2694),
        .pwm1(Net_2695),
	...
	cy_clock_v1_0
		#(.id("2ef4aee9-3449-47fb-a2e4-72add9548979"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("10000000000"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b354a010-6f79-4666-8a90-54748f509459"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("e18dec83-55ee-45ad-b9f5-5a69753a45e3"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
