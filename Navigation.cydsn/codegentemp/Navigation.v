...
module top ;
    ...
    UART_v2_50_1 UART (
        ...
        .reset(1'b0),
        .rx(Net_248),
        .tx_interrupt(Net_1090),
        .rx_interrupt(Net_1091),
        .tx_data(Net_1092),
        .tx_clk(Net_1093),
        .rx_data(Net_1094),
        .rx_clk(Net_1095));
	...
	cy_psoc3_pins_v1_10
		#(.id("0ed46d7f-1aaa-43e2-8c80-6a3add727572"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    VDAC8_v1_90_5 VDAC8_1 (
        ...
        .data(Net_1822[7:0]),
        .vOut(Net_1825));
    defparam VDAC8_1.Data_Source = 1;
    defparam VDAC8_1.Initial_Value = 64;
    defparam VDAC8_1.Strobe_Mode = 1;

    Timer_v2_80_6 VideoTimer (
        .reset(Net_1886),
        .interrupt(Net_1854),
        .enable(Net_1886),
        .trigger(1'b1),
        .capture(Net_1857),
        .capture_out(Net_1858),
        .tc(Net_1859),
        .clock(Net_1821));
    ...
    Count7_v1_0 Counter (
        ...
        .cnt(Net_1883[6:0]),
        .tc(Net_1886));
    defparam Counter.EnableSignal = 0;
    defparam Counter.LoadSignal = 0;

    assign Net_1893 = 1'h1;

    assign Net_1898 = 1'h0;
	...
	cy_psoc3_pins_v1_10
		#(.id("ead56969-a621-433e-845a-85ef6fc17d26"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("62f3a023-5c08-4145-92c5-8f6faf03e0ce"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
