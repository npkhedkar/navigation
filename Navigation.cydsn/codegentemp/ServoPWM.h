...
**************************************/
#define ServoPWM_INIT_PERIOD_VALUE          (200u)
#define ServoPWM_INIT_COMPARE_VALUE1        (152u)
...
******************************** */
   ...
   #define ServoPWM_RT1_PTR                 ( (reg8 *)  ServoPWM_PWMHW__RT1)
       ...
       #if(ServoPWM_PWMModeIsCenterAligned)
           #define ServoPWM_PERIOD_LSB      (*(reg8 *)  ServoPWM_PWMUDB_sP8_pwmdp_u0__D1_REG)
           #define ServoPWM_PERIOD_LSB_PTR  ((reg8 *)   ServoPWM_PWMUDB_sP8_pwmdp_u0__D1_REG)
       #else
           #define ServoPWM_PERIOD_LSB      (*(reg8 *)  ServoPWM_PWMUDB_sP8_pwmdp_u0__F0_REG)
           #define ServoPWM_PERIOD_LSB_PTR  ((reg8 *)   ServoPWM_PWMUDB_sP8_pwmdp_u0__F0_REG)
       #endif /* (ServoPWM_PWMModeIsCenterAligned) */

       #define ServoPWM_COMPARE1_LSB        (*(reg8 *)  ServoPWM_PWMUDB_sP8_pwmdp_u0__D0_REG)
       #define ServoPWM_COMPARE1_LSB_PTR    ((reg8 *)   ServoPWM_PWMUDB_sP8_pwmdp_u0__D0_REG)
       #define ServoPWM_COMPARE2_LSB        (*(reg8 *)  ServoPWM_PWMUDB_sP8_pwmdp_u0__D1_REG)
       #define ServoPWM_COMPARE2_LSB_PTR    ((reg8 *)   ServoPWM_PWMUDB_sP8_pwmdp_u0__D1_REG)
       #define ServoPWM_COUNTERCAP_LSB      (*(reg8 *)  ServoPWM_PWMUDB_sP8_pwmdp_u0__A1_REG)
       #define ServoPWM_COUNTERCAP_LSB_PTR  ((reg8 *)   ServoPWM_PWMUDB_sP8_pwmdp_u0__A1_REG)
       #define ServoPWM_COUNTER_LSB         (*(reg8 *)  ServoPWM_PWMUDB_sP8_pwmdp_u0__A0_REG)
       #define ServoPWM_COUNTER_LSB_PTR     ((reg8 *)   ServoPWM_PWMUDB_sP8_pwmdp_u0__A0_REG)
       #define ServoPWM_CAPTURE_LSB         (*(reg8 *)  ServoPWM_PWMUDB_sP8_pwmdp_u0__F1_REG)
       #define ServoPWM_CAPTURE_LSB_PTR     ((reg8 *)   ServoPWM_PWMUDB_sP8_pwmdp_u0__F1_REG)

   #else
        #if(CY_PSOC3) /* 8-bit address space */
            #if(ServoPWM_PWMModeIsCenterAligned)
               #define ServoPWM_PERIOD_LSB      (*(reg16 *) ServoPWM_PWMUDB_sP8_pwmdp_u0__D1_REG)
               #define ServoPWM_PERIOD_LSB_PTR  ((reg16 *)  ServoPWM_PWMUDB_sP8_pwmdp_u0__D1_REG)
            #else
               #define ServoPWM_PERIOD_LSB      (*(reg16 *) ServoPWM_PWMUDB_sP8_pwmdp_u0__F0_REG)
               #define ServoPWM_PERIOD_LSB_PTR  ((reg16 *)  ServoPWM_PWMUDB_sP8_pwmdp_u0__F0_REG)
            #endif /* (ServoPWM_PWMModeIsCenterAligned) */

            #define ServoPWM_COMPARE1_LSB       (*(reg16 *) ServoPWM_PWMUDB_sP8_pwmdp_u0__D0_REG)
            #define ServoPWM_COMPARE1_LSB_PTR   ((reg16 *)  ServoPWM_PWMUDB_sP8_pwmdp_u0__D0_REG)
            #define ServoPWM_COMPARE2_LSB       (*(reg16 *) ServoPWM_PWMUDB_sP8_pwmdp_u0__D1_REG)
            #define ServoPWM_COMPARE2_LSB_PTR   ((reg16 *)  ServoPWM_PWMUDB_sP8_pwmdp_u0__D1_REG)
            #define ServoPWM_COUNTERCAP_LSB     (*(reg16 *) ServoPWM_PWMUDB_sP8_pwmdp_u0__A1_REG)
            #define ServoPWM_COUNTERCAP_LSB_PTR ((reg16 *)  ServoPWM_PWMUDB_sP8_pwmdp_u0__A1_REG)
            #define ServoPWM_COUNTER_LSB        (*(reg16 *) ServoPWM_PWMUDB_sP8_pwmdp_u0__A0_REG)
            #define ServoPWM_COUNTER_LSB_PTR    ((reg16 *)  ServoPWM_PWMUDB_sP8_pwmdp_u0__A0_REG)
            #define ServoPWM_CAPTURE_LSB        (*(reg16 *) ServoPWM_PWMUDB_sP8_pwmdp_u0__F1_REG)
            #define ServoPWM_CAPTURE_LSB_PTR    ((reg16 *)  ServoPWM_PWMUDB_sP8_pwmdp_u0__F1_REG)
        #else
            #if(ServoPWM_PWMModeIsCenterAligned)
               #define ServoPWM_PERIOD_LSB      (*(reg16 *) ServoPWM_PWMUDB_sP8_pwmdp_u0__16BIT_D1_REG)
               #define ServoPWM_PERIOD_LSB_PTR  ((reg16 *)  ServoPWM_PWMUDB_sP8_pwmdp_u0__16BIT_D1_REG)
            #else
               #define ServoPWM_PERIOD_LSB      (*(reg16 *) ServoPWM_PWMUDB_sP8_pwmdp_u0__16BIT_F0_REG)
               #define ServoPWM_PERIOD_LSB_PTR  ((reg16 *)  ServoPWM_PWMUDB_sP8_pwmdp_u0__16BIT_F0_REG)
            #endif /* (ServoPWM_PWMModeIsCenterAligned) */

            #define ServoPWM_COMPARE1_LSB       (*(reg16 *) ServoPWM_PWMUDB_sP8_pwmdp_u0__16BIT_D0_REG)
            #define ServoPWM_COMPARE1_LSB_PTR   ((reg16 *)  ServoPWM_PWMUDB_sP8_pwmdp_u0__16BIT_D0_REG)
            #define ServoPWM_COMPARE2_LSB       (*(reg16 *) ServoPWM_PWMUDB_sP8_pwmdp_u0__16BIT_D1_REG)
            #define ServoPWM_COMPARE2_LSB_PTR   ((reg16 *)  ServoPWM_PWMUDB_sP8_pwmdp_u0__16BIT_D1_REG)
            #define ServoPWM_COUNTERCAP_LSB     (*(reg16 *) ServoPWM_PWMUDB_sP8_pwmdp_u0__16BIT_A1_REG)
            #define ServoPWM_COUNTERCAP_LSB_PTR ((reg16 *)  ServoPWM_PWMUDB_sP8_pwmdp_u0__16BIT_A1_REG)
            #define ServoPWM_COUNTER_LSB        (*(reg16 *) ServoPWM_PWMUDB_sP8_pwmdp_u0__16BIT_A0_REG)
            #define ServoPWM_COUNTER_LSB_PTR    ((reg16 *)  ServoPWM_PWMUDB_sP8_pwmdp_u0__16BIT_A0_REG)
            #define ServoPWM_CAPTURE_LSB        (*(reg16 *) ServoPWM_PWMUDB_sP8_pwmdp_u0__16BIT_F1_REG)
            #define ServoPWM_CAPTURE_LSB_PTR    ((reg16 *)  ServoPWM_PWMUDB_sP8_pwmdp_u0__16BIT_F1_REG)
        #endif /* (CY_PSOC3) */

       #define ServoPWM_AUX_CONTROLDP1          (*(reg8 *)  ServoPWM_PWMUDB_sP8_pwmdp_u1__DP_AUX_CTL_REG)
       #define ServoPWM_AUX_CONTROLDP1_PTR      ((reg8 *)   ServoPWM_PWMUDB_sP8_pwmdp_u1__DP_AUX_CTL_REG)

   #endif /* (ServoPWM_Resolution == 8) */

   #define ServoPWM_COUNTERCAP_LSB_PTR_8BIT ( (reg8 *)  ServoPWM_PWMUDB_sP8_pwmdp_u0__A1_REG)
   #define ServoPWM_AUX_CONTROLDP0          (*(reg8 *)  ServoPWM_PWMUDB_sP8_pwmdp_u0__DP_AUX_CTL_REG)
   #define ServoPWM_AUX_CONTROLDP0_PTR      ((reg8 *)   ServoPWM_PWMUDB_sP8_pwmdp_u0__DP_AUX_CTL_REG)
